...
`git clone https://github.com/ByteLegendQuest/java-deserialize-github-api-json`

A project directory named `java-deserialize-github-api-json` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-deserialize-github-api-json` directory which is created just now.
